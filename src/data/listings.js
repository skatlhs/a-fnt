const listings = [
  {
  	...
  	listings: [
  	  {
  	  	id: 1,
        photo: require('./img/listing1.png'),
        type: 'BOAT RIDE',
  	  ...
  	  {
  	  	id: 2,
        photo: require('./img/listing2.png'),
        type: 'CHEESE TASTING',
  	  ...
  	  {
  	  	id: 3,
        photo: require('./img/listing3.png'),
        type: 'BIKE RIDE',
  	  ...
  	  {
  	  	id: 4,
        photo: require('./img/listing4.png'),
        type: 'BIKE RIDE',
  	  ...
  	  {
  	  	id: 5,
        photo: require('./img/listing5.png'),
        type: 'SURFING',
  	  ...
  	  {
  	  	id: 6,
        photo: require('./img/listing6.png'),
        type: 'DRAWING CLASS',
  ...
  },
  {
  	...
  	listings: [
   	  {
  	  	id: 7,
        photo: require('./img/listing7.png'),
        ...
        stars: 101,
   	  ...
   	  {
  	  	id: 8,
        photo: require('./img/listing8.png'),
        ...
        stars: 119,
   	  ...
   	  {
  	  	id: 9,
        photo: require('./img/listing9.png'),
        type: 'ENTIRE HOUSE - 1 BED',
        ...
        stars: 320,
   	  ...
   	  {
  	  	id: 10,
        photo: require('./img/listing10.png'),
        ...
        stars: 300,
   	  ...
   	  {
  	  	id: 11,
        photo: require('./img/listing11.png'),
  ...
  },
  {
  	...
  	listings: [
  	  {
  	    id: 12,
  	    photo: require('./img/listing12.png'),
  	    type: 'RESERVATION',
  	    title: 'G\'raj Mahal',
  	    price: '30',
  	    priceType: 'per person',
  	  ...
  	  {
  	    id: 13,
  	    photo: require('./img/listing13.png'),
  	    type: 'RESERVATION',
  	    title: 'Le Fond',
  	    price: '30',
  	    priceType: 'per person',
  	  ...
  	  {
  	    id: 14,
  	    photo: require('./img/listing14.png'),
  	    type: 'RESERVATION',
  	  ...
  	  {
  	    id: 15,
  	    photo: require('./img/listing15.png'),
  	    type: 'RESERVATION',
      ...
      {
        id: 16,
        photo: require('./img/listing16.png'),
        type: 'RESERVATION',
        title: 'Bar Boulud',
        price: '46',
        priceType: 'per person',
